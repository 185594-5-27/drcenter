...
public class CryptLib {
	 ...
	 */
		...
		if (_mode.equals(EncryptMode.DECRYPT)) {
			...
			byte[] decodedValue = Base64.decode(_inputText);
 	...
 	private byte[] encryptDecrypt(byte[] _inputText, String _encryptionKey,
		...
		if (_mode.equals(EncryptMode.ENCRYPT)) {
			_cx.init(Cipher.ENCRYPT_MODE, keySpec, ivSpec);// Initialize this cipher instance
			return _cx.doFinal(_inputText); // Finish
		}
		...
		return null; // return encrypted/decrypted string
	}
	...
	public byte[] encrypt(byte[] _plainText, String _key, String _iv)
			throws InvalidKeyException, UnsupportedEncodingException,
			InvalidAlgorithmParameterException, IllegalBlockSizeException,
			BadPaddingException {
		return encryptDecrypt(_plainText, _key, EncryptMode.ENCRYPT, _iv);
	...
	public byte[] decrypt(byte[] _encryptedText, String _key, String _iv)
			throws InvalidKeyException, UnsupportedEncodingException,
			InvalidAlgorithmParameterException, IllegalBlockSizeException,
			BadPaddingException {
		return encryptDecrypt(_encryptedText, _key, EncryptMode.DECRYPT, _iv);
